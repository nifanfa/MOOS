...
namespace Internal.Runtime
{
	...
	public unsafe struct EEType
	{
		...
		internal static class WellKnownEETypes
		{
			...
			{
				return !pEEType->IsArray && (pEEType->NonArrayBaseType == null) && !pEEType->IsInterface;
			}
		...
		internal EEType* NonArrayBaseType
		{
			get
			{
				...
				return IsRelatedTypeViaIAT ? *_relatedType._ppBaseTypeViaIAT : _relatedType._pBaseType;
			}
		}

		internal EEType* NonClonedNonArrayBaseType => IsRelatedTypeViaIAT ? *_relatedType._ppBaseTypeViaIAT : _relatedType._pBaseType;
		...
		internal EEType* CanonicalEEType =>
					...
					IsRelatedTypeViaIAT ? *_relatedType._ppCanonicalTypeViaIAT : _relatedType._pCanonicalType;
		...
		internal EEType* RelatedParameterType => IsRelatedTypeViaIAT ? *_relatedType._ppRelatedParameterTypeViaIAT : _relatedType._pRelatedParameterType;
