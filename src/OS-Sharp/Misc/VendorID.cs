...
namespace Kernel.Misc
{
    public static class VendorID
    {
        public static string GetName(ushort id)
        {
            ...
            if (id == 0x1131) return "NXP Semiconductors N.V.";
            ...
            if (id == 0x11A1) return "Hamamatsu Photonics K.K.";
            ...
            if (id == 0x11C7) return "D.C.M. Data Systems";
            ...
            if (id == 0x1267) return "S.A. Telecommunications";
            ...
            if (id == 0x127E) return "Winnov L.P.";
            ...
            if (id == 0x1361) return "Soliton Systems K.K.";
            ...
            if (id == 0x13D6) return "K.I. Technology Co Ltd";
            ...
            if (id == 0x13F1) return "OCE - Industries S.A.";
            ...
            if (id == 0x1406) return "Oce Print Logics Technologies S.A.";
            ...
            if (id == 0x1443) return "Unibrain S.A.";
            ...
            if (id == 0x148C) return "C.P. Technology Co. Ltd";
            ...
            if (id == 0x14B1) return "Nextcom K.K.";
            if (id == 0x14B3) return "Xpeed Inc.";
            if (id == 0x14B4) return "Philips Business Electronics B.V.";
            ...
            if (id == 0x15EA) return "Tokyo Denshi Sekei K.K.";
            ...
            if (id == 0x15FD) return "N-Cubed.Net";
            ...
            if (id == 0x1629) return "Kongsberg Spacetec a.s.";
            ...
            if (id == 0x1635) return "Decros / S.ICZ a.s.";
            ...
            if (id == 0x186C) return "Humusoft S.R.O";
            ...
            if (id == 0x3411) return "Quantum Designs (H.K.) Inc.";
            ...
            if (id == 0x7604) return "O.N. Electric Co. Ltd.";
            ...
            if (id == 0xEABB) return "Aashima Technology B.V.";
