...
namespace OS_Sharp.Misc
{
    ...
    {
        public static string GetClassName(byte id)
        {
            return id switch
            {
        ...
        public static string GetProcessorTypeName(byte id)
        {
            return id switch
            {
                0x1 => "Other",
        ...
        public static string[] GetProcessorCharacteristics(ushort c)
        {
            System.Collections.Generic.List<string> x = new();
            if (c.GetBit(1) != 0)
            {
                x.Add("Unknown");
            }
            ...
            if (c.GetBit(4) != 0)
            {
                x.Add("Hardware Thread");
            }

            if (c.GetBit(5) != 0)
            {
                x.Add("Execute Protection");
            }

            if (c.GetBit(6) != 0)
            {
                x.Add("Enhanced Virtualization");
            }

            if (c.GetBit(7) != 0)
            {
                x.Add("Power/Performance Control");
            }

            if (c.GetBit(8) != 0)
            {
                x.Add("128-Bit Capable");
            }
        ...
        public static double[] GetProcessorVoltages(byte voltage)
        {
            System.Collections.Generic.List<double> voltages = new();
            if (voltage.GetBit(7) != 0)
            {
                voltages.Add(voltage.GetBitRange(0, 5));
            }
            else
            {
                if (voltage.GetBit(0) != 0)
                {
                    voltages.Add(5.5);
                }

                if (voltage.GetBit(1) != 0)
                {
                    voltages.Add(3.3);
                }

                if (voltage.GetBit(2) != 0)
                {
                    voltages.Add(2.9);
                }
            }

            double[] y = voltages.ToArray();
            voltages.Dispose();
            return y;
        }

        public static string GetProcessorName(ushort id)
        {
            return id switch
            {
                0x1 => "Other",
                ...
                0x3 => "8086",
                0x4 => "80286",
                0x5 => "Intel386(TM) Processor",
                0x6 => "Intel486(TM) Processor",
                0x7 => "8087",
                0x8 => "80287",
                0x9 => "80387",
                0xA => "80487",
                0xB => "Intel(R) Pentium(R) Processor",
                0xC => "Pentium(R) Pro Processor",
                0xD => "Pentium(R) II Processor",
                0xE => "Pentium(R) Processor with MMX(TM) technology",
                0xF => "Intel(R) Celeron(R) Processor",
                0x10 => "Pentium(R) II Xeon(TM) Processor",
                0x11 => "Pentium(R) III Processor",
                0x12 => "M1 Family",
                0x13 => "M2 Family",
                0x14 => "Intel(R) Celeron(R) M Processor",
                0x15 => "Intel(R) Pentium(R) 4 HT Processor",
                ...
                0x26 => "Power PC x704",
                0x27 => "Power PC 750",
                0x28 => "Intel(R) Core(TM) Duo Processor",
                0x29 => "Intel(R) Core(TM) Duo mobile Processor",
                0x2A => "Intel(R) Core(TM) Solo mobile Processor",
                0x2B => "Intel(R) Atom(TM) Processor",
                0x2C => "Intel(R) Core(TM) M Processor",
                ...
                0x36 => "Alpha 21264",
                0x37 => "Alpha 21364",
                0x38 => "AMD Turion(TM) II Ultra Dual-Core Mobile M Processor Family",
                0x39 => "AMD Turion(TM) II Dual-Core Mobile M Processor Family",
                0x3A => "AMD Athlon(TM) II Dual-Core M Processor Family",
                0x3B => "AMD Opteron(TM) 6100 Series Processor",
                0x3C => "AMD Opteron(TM) 4100 Series Processor",
                0x3D => "AMD Opteron(TM) 6200 Series Processor",
                0x3E => "AMD Opteron(TM) 4200 Series Processor",
                0x3F => "AMD FX(TM) Series Processor",
                0x40 => "MIPS Family",
                0x41 => "MIPS R4000",
                0x42 => "MIPS R4200",
                0x43 => "MIPS R4400",
                ...
                0x4C => "AMD Opteron(TM) 4300 Series Processor",
                0x4D => "AMD Opteron(TM) 6300 Series Processor",
                0x4E => "AMD Opteron(TM) 3300 Series Processor",
                0x4F => "AMD FirePro(TM) Series Processor",
                0x50 => "SPARC Family",
                0x51 => "SuperSPARC",
                0x52 => "microSPARC II",
                ...
                0x8A => "Quad-Core AMD Opteron(TM) Processor Family",
                0x8B => "Third-Generation AMD Opteron(TM) Processor Family",
                0x8C => "AMD Phenom(TM) FX Quad-Core Processor Family",
                0x8D => "AMD Phenom(TM) X4 Quad-Core Processor Family",
                0x8E => "AMD Phenom(TM) X2 Dual-Core Processor Family",
                0x8F => "AMD Athlon(TM) X2 Dual-Core Processor Family",
                0x90 => "PA-RISC Family",
                0x91 => "PA-RISC 8500",
                0x92 => "PA-RISC 8000",
                0x93 => "PA-RISC 7300LC",
                ...
                0x96 => "PA-RISC 7100",
                0xA0 => "V30 Family",
                0xA1 => "Quad-Core Intel(R) Xeon(R) Processor 3200 Series",
                0xA2 => "Dual-Core Intel(R) Xeon(R) Processor 3000 Series",
                0xA3 => "Quad-Core Intel(R) Xeon(R) Processor 5300 Series",
                0xA4 => "Dual-Core Intel(R) Xeon(R) Processor 5100 Series",
                0xA5 => "Dual-Core Intel(R) Xeon(R) Processor 5000 Series",
                0xA6 => "Dual-Core Intel(R) Xeon(R) Processor LV",
                0xA7 => "Dual-Core Intel(R) Xeon(R) Processor ULV",
                0xA8 => "Dual-Core Intel(R) Xeon(R) Processor 7100 Series",
                0xA9 => "Quad-Core Intel(R) Xeon(R) Processor 5400 Series",
                0xAA => "Quad-Core Intel(R) Xeon(R) Processor",
                0xAB => "Dual-Core Intel(R) Xeon(R) Processor 5200 Series",
                0xAC => "Dual-Core Intel(R) Xeon(R) Processor 7200 Series",
                0xAD => "Quad-Core Intel(R) Xeon(R) Processor 7300 Series",
                0xAE => "Quad-Core Intel(R) Xeon(R) Processor 7400 Series",
                0xAF => "Multi-Core Intel(R) Xeon(R) Processor 7400 Series",
                0xB0 => "Pentium(R) III Xeon(TM) Processor",
                0xB1 => "Pentium(R) III Processor with Intel(R) SpeedStep(TM) Technology",
                0xB2 => "Pentium(R) 4 Processor",
                0xB3 => "Intel(R) Xeon(R) Processor",
                0xB4 => "AS400 Family",
                0xB5 => "Intel(R) Xeon(TM) Processor MP",
                0xB6 => "AMD Athlon(TM) XP Processor Family",
                0xB7 => "AMD Athlon(TM) MP Processor Family",
                0xB8 => "Intel(R) Itanium(R) 2 Processor",
                0xB9 => "Intel(R) Pentium(R) M Processor",
                0xBA => "Intel(R) Celeron(R) D Processor",
                0xBB => "Intel(R) Pentium(R) D Processor",
                0xBC => "Intel(R) Pentium(R) Processor Extreme Edition",
                0xBD => "Intel(R) Core(TM) Solo Processor",
                0xBF => "Intel(R) Core(TM) 2 Duo Processor",
                0xC0 => "Intel(R) Core(TM) 2 Solo Processor",
                0xC1 => "Intel(R) Core(TM) 2 Extreme Processor",
                0xC2 => "Intel(R) Core(TM) 2 Quad Processor",
                0xC3 => "Intel(R) Core(TM) 2 Extreme mobile Processor",
                0xC4 => "Intel(R) Core(TM) 2 Duo mobile Processor",
                0xC5 => "Intel(R) Core(TM) 2 Solo mobile Processor",
                0xC6 => "Intel(R) Core(TM) i7 Processor",
                0xC7 => "Dual-Core Intel(R) Celeron(R) Processor",
                0xC8 => "IBM390 Family",
                0xC9 => "G4",
                0xCA => "G5",
                0xCB => "ESA/390 G6",
                0xCC => "z/Architecture base",
                0xCD => "Intel(R) Core(TM) i5 Processor",
                0xCE => "Intel(R) Core(TM) i3 Processor",
                0xCF => "Intel(R) Core(TM) i9 Processor",
                ...
                0xD6 => "Multi-Core Intel(R) Xeon(R) Processor",
                0xD7 => "Dual-Core Intel(R) Xeon(R) Processor 3xxx Series",
                0xD8 => "Quad-Core Intel(R) Xeon(R) Processor 3xxx Series",
                0xD9 => "VIA Nano(TM) Processor Family",
                0xDA => "Dual-Core Intel(R) Xeon(R) Processor 5xxx Series",
                0xDB => "Quad-Core Intel(R) Xeon(R) Processor 5xxx Series",
                0xDD => "Dual-Core Intel(R) Xeon(R) Processor 7xxx Series",
                0xDE => "Quad-Core Intel(R) Xeon(R) Processor 7xxx Series",
                0xDF => "Multi-Core Intel(R) Xeon(R) Processor 7xxx Series",
                0xE0 => "Multi-Core Intel(R) Xeon(R) Processor 3400 Series",
                0xE4 => "AMD Opteron(TM) 3000 Series Processor",
                0xE5 => "AMD Sempron(TM) II Processor",
                0xE6 => "Embedded AMD Opteron(TM) Quad-Core Processor Family",
                0xE7 => "AMD Phenom(TM) Triple-Core Processor Family",
                0xE8 => "AMD Turion(TM) Ultra Dual-Core Mobile Processor Family",
                0xE9 => "AMD Turion(TM) Dual-Core Mobile Processor Family",
                0xEA => "AMD Athlon(TM) Dual-Core Processor Family",
                0xEB => "AMD Sempron(TM) SI Processor Family",
                0xEC => "AMD Phenom(TM) II Processor Family",
                0xED => "AMD Athlon(TM) II Processor Family",
                0xEE => "Six-Core AMD Opteron(TM) Processor Family",
                0xEF => "AMD Sempron(TM) M Processor Family",
                0xFA => "i860",
                0xFB => "i960",
                0x100 => "ARMv7",
                0x101 => "ARMv8",
