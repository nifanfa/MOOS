...
namespace NES
{
	public class CPU
	{
				...
				case 0x24:  // BIT - Absolute Zero-Page
					{
						...
						registers.statusZero = (registers.regA & intTemp) == 0;

						// Place Bit 7 value in Negative(sign) status bit
						registers.statusNegative = (intTemp & 0x80) == 0x80;

						// Place Bit 6 value in Overflow status bit
						registers.statusOverflow = (intTemp & 0x40) == 0x40;
				...
				case 0x4A:  // LSR - Accumulator
					{
						...
						registers.statusCarry = (registers.regA & 0x01) == 0x01;
				...
				case 0x46:  // LSR - Absolute Zero-Page
					{
						...
						// Check Low Bit for Carry to the Right before doing Shift Right
						registers.statusCarry = (intMem & 0x01) == 0x01;
				...
				case 0x2A:  // ROL - Accumulator
					{
						...
						bolRegACarry = (intRegA & 0x80) == 0x80;
				...
				case 0x6A:  // ROR - Accumulator
					{
						...
						// Set Carry based on intRegA
						bolRegACarry = (intRegA & 0x01) == 0x01;
		...
		private bool checkStatusOverflowADC(byte regA, uint result, byte byteOne)        // Check for Overflow
		{
			...
			{ /* MessageBox.Show("False");*/ return false; }
		}
		...
		private void pageChangeCheck(int intAddr)
		{
			...
			bolPageChanged = (intLastAddress & 0xFF00) != (intNewAddress & 0xFF00);
