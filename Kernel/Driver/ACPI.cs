...
#pragma warning disable CS0649
    public unsafe class ACPI
    {
        ...
        public static ACPI_FADT* FADT { get; set; }
        public static ACPI_MADT* MADT { get; set; }
        public static APIC_IO_APIC* IO_APIC { get; set; }
        public static ACPI_HPET* HPET { get; set; }
        public static MCFGHeader* MCFG { get; set; }
        ...
        public static void Initialize()
        {
            ...
            Console.WriteLineInfo("ACPI", "ACPI Initialized");
        }
