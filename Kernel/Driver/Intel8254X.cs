...
namespace MOOS.Driver
{
    public unsafe class Intel8254X : NIC
    {
        ...
        public static int Speed => (ReadRegister(8) & (3 << 6)) == 0
                    ? 10
                    : (ReadRegister(8) & (2 << 6)) != 0 ? 1000 : (ReadRegister(8) & (1 << 6)) != 0 ? 100 : 0;
        ...
        public static void Initialize()
        {
            ...
            Console.WriteLineInfo("Intel8254X", "Intel 8254X Series Gigabit Ethernet Controller Found");
            device.WriteRegister(0x04, 0x04 | 0x02 | 0x01);

            BAR0 = (uint)(device.Bar0 & (~0xF));
            Console.WriteInfo("Intel8254X", "BAR0: 0x");
            ...
            if (!HasEEPROM)
            {
                ...
                Console.WriteLineInfo("Intel8254X", "This controller has no EEPROM");
            } else
            {
                ...
                Console.WriteLineInfo("Intel8254X", "EEPROM on this controller");
            }

            Console.WriteInfo("Intel8254X", "MAC:");
            ...
            Console.WriteInfo("Intel8254X", "IRQ: ");
        ...
        public static void OnInterrupt()
        {
            ...
            if ((Status & 0x04) != 0)
            {
                //Console.WriteLineInfo("Intel8254X", "Linking Up");
                Linkup();
            }
            if ((Status & 0x10) != 0)
            {
                //Console.WriteLineInfo("Intel8254X", "Good Threshold");
            }

            if ((Status & 0x80) != 0)
            {
                //Console.WriteLineInfo("Intel8254X", "Packet Received");
                uint _RXCurr = RXCurr;
        ...
        private static void Linkup()
        {
            ...
            Console.WriteInfo("Intel8254X", "Waiting for network connection ");
