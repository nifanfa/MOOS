...
namespace MOOS.NET
{
    public unsafe class RTL8139 : NIC
    {
        ...
        public static void Initialize()
        {
            ...
            Console.WriteLineInfo("RTL8139", "RTL8139 Found!");
            ...
            Console.WriteLineInfo("RTL8139", "Soft-Reset Done");

            uint p = (uint)Allocator.Allocate(8192 + 16 + 1500 + 0xF);
            p &= ~0xFU;
            Console.WriteInfo("RTL8139", "RX is at:");
            ...
            Console.WriteLineInfo("RTL8139", "RTL8139 Configuration D0ne");
            Console.WriteInfo("RTL8139", "IRQ:");
