    ...
    public static unsafe class ARP
    {
        ...
        internal static void HandlePacket(byte* data, int length)
        {
                ...
                )
            {
                ...
                {
                    ARPHeader* _hdr = (ARPHeader*)Memory.Allocate((ulong)(sizeof(ARPHeader)));
        ...
        {
            ARPHeader* hdr = (ARPHeader*)Memory.Allocate((ulong)(sizeof(ARPHeader)));
