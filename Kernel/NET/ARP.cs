    ...
    public static unsafe class ARP
    {
        ...
        internal static void HandlePacket(byte* data, int length)
        {
                ...
                )
            {
                ...
                {
                    ARPHeader* _hdr = (ARPHeader*)liballoc.alloc((ulong)(sizeof(ARPHeader)));
        ...
        {
            ARPHeader* hdr = (ARPHeader*)liballoc.alloc((ulong)(sizeof(ARPHeader)));
