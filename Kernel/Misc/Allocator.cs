...
abstract class Allocator
{
    ...
    const int BITMAP_LENGTH = 32768 * 3; // 32kb can hold enough bits to represent 262,144 pages, allowing up to 1024mb to be allocated (assuming a page size of 4kb)
